...
Besides creating webhooks manually in [Apify Console](https://docs.apify.com/platform/console), or through the Apify API, you can also create [ad-hoc webhooks](https://docs.apify.com/platform/integrations/webhooks/ad-hoc-webhooks) dynamically from the code of your Actor using the <ApiLink to="class/Actor#add_webhook">`Actor.add_webhook`</ApiLink> method:
