...
Apify SDK for Python is the official library to create [Apify Actors](https://docs.apify.com/platform/actors) in Python.
...
They can do anything from small tasks like filling in forms or unsubscribing from online services,
...
particularly the guides for the [Actor lifecycle](../concepts/actor-lifecycle),
[working with storages](../concepts/storages),
[handling Actor events](../concepts/actor-events)
or [how to use proxies](../concepts/proxy-management).
