...
- **Actor input** — access to the Actor input, including automatic decryption of secret fields.
...
- **Framework integrations** — support for [Crawlee](../guides/crawlee) and [Scrapy](../guides/scrapy), with guides for [Playwright](../guides/playwright) and others.
