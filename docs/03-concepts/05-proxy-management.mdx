...
To make selecting proxies the Actor uses easier,
you can use an input field with editor [`proxy` in your input schema](https://docs.apify.com/platform/actors/development/input-schema#object).
